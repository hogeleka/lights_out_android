...
import com.algorithmandblues.lightsout.utils.ProgressBarAnimation;
...
public class GameSummaryActivity extends AppCompatActivity {
    ...
    private void goToNextLevel() {
        boolean hasDataForNextLevel = gameDataDBHandler.getMostRecentGameDataForGameType(nextLevel.getDimension(), nextLevel.getGameMode()) != null;

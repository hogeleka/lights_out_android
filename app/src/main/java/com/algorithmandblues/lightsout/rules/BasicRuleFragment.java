...
public class BasicRuleFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        turnOffAllTheLightsGif = ActivityDrawingUtils.createGif(getContext(), gifSize,  R.drawable.turn_off_all_the_lights, GIF_PADDING_TOP, GIF_PADDING_BOTTOM);
        neighborToggleGif = ActivityDrawingUtils.createGif(getContext(), gifSize, R.drawable.bulb_neighbor_rule, GIF_PADDING_TOP, GIF_PADDING_BOTTOM);

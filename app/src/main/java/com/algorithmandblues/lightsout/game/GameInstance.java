...
import com.algorithmandblues.lightsout.BR;
...
public class GameInstance extends BaseObservable {
    ...
    GameInstance(Context context, final GameData gameData) {
        this.context = context;
        this.gameMode = gameData.getGameMode();
        this.dimension = gameData.getDimension();
        this.originalStartState = DataUtil.stringToByteArray(gameData.getOriginalStartState());
        this.currentToggledBulbs = DataUtil.stringToByteArray(gameData.getToggledBulbsState());
        ...
        this.undoStack = DataUtil.stringToIntegerStack(gameData.getUndoStackString());
        this.redoStack = DataUtil.stringToIntegerStack(gameData.getRedoStackString());
        this.hintsAllowed = HINTS_ALLOWED_MAP.get(this.dimension);
        this.hintsUsed = gameData.getNumberOfHintsUsed();
        this.hintsLeft = this.calculateHintsLeft(this.hintsAllowed, this.hintsUsed);
        this.hasSeenSolution = gameData.getHasSeenSolution();
        ...
        byte[] originalIndividualBulbStatusFromDB = DataUtil.stringToByteArray(gameData.getOriginalIndividualBulbStatus());
        ...
        this.setMoveCounter(gameData.getMoveCounter());
        this.moveCounterPerBulb = DataUtil.stringToIntegerArray(gameData.getMoveCounterPerBulbString());
